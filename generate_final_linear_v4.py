...
# 2. Hardcoded Chapters for Book 1 (Stories of Sahaabah)
BOOK1_CHAPTERS = [
...
def generate_final_v4():
    ...
    # Sort ToC entries by Page Number to match flow
    # Filter out entries without pages first
    ...
    for i, entry in enumerate(valid_entries):
        ...
        if book_id == 1:
            ...
            for ch in BOOK1_CHAPTERS:
             ...
             # Generic Chapter for other books
        ...
        if i + 1 < len(valid_entries):
            next_page = valid_entries[i+1]['page']
    ...
    # Generate Chapters List for UI
    final_chapters = {}
    cid = 100
    # Pre-populate Book 1 Chapters (so they exist even if empty?)
    for ch in BOOK1_CHAPTERS:
